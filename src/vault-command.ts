      ...
      if (resolved.telemetry.usedGuidance) {
        logVaultMetric({
          ...
          extra: {
            ...
            safe_text_primary_used: resolved.telemetry.safeTextPrimaryUsed,
            safe_text_fallback_used: resolved.telemetry.safeTextFallbackUsed,
            safe_text_fallback_failed: resolved.telemetry.safeTextFallbackFailed,
            retry_status: resolved.telemetry.retryStatus,
